  ...
  return (
    <div>
      <div className="min-h-screen">
        ...
        <div className="bg-slate-700 text-white rounded-md h-40 mx-10 flex items-center justify-center">
          <h2 className="text-semibold text-3xl mx-10 py-2  ">{theory.answer}</h2>
        </div>
